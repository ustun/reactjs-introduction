...
var Counters = React.createClass({displayName: "Counters",
  ...
  render: function () {
     return (
       React.createElement("div", null, 
        React.createElement(Counter, {counter: this.state.counter1, artir: this.incrementCounter1}), 
        React.createElement(Counter, {counter: this.state.counter2, artir: this.incrementCounter2})
      ));
  }
})
